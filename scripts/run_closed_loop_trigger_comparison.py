...
def command_for(
    *,
    ...
    model: str,
    output: Path,
    state_workbook: Path | str = "inputs/State.xlsx",
    forecast_workbook: Path | str = "inputs/Forecasted.xlsx",
    spot_prices: Path | str = "inputs/SpotPrices.xlsx",
    ...
    return [
        ...
        str(trigger_confidence_threshold),
